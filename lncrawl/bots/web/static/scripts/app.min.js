...
$(document).ready(function () {
	var n; if ($("#search-section")[0]) {
		n = document.createElement("link"); n.href = "https://cdnjs.cloudflare.com/ajax/libs/selectize.js/0.12.6/css/selectize.default.min.css"; n.integrity = "sha256-ibvTNlNAB4VMqE5uFlnBME6hlparj5sEr1ovZ3B/bNA="; n.crossOrigin = "anonymous"; n.rel = "stylesheet"; n.type = "text/css"; document.getElementsByTagName("head")[0].appendChild(n); var t = [], i = [], r = [], u = [], f = [], e = [-1]; $.getScript("https://cdnjs.cloudflare.com/ajax/libs/selectize.js/0.12.6/js/standalone/selectize.min.js", function () {
			var n = $("#categories").selectize({
				plugins: ["remove_button"], maxItems: 5, onChange: function (n) {
					i = n
				}

			}), o = $("#publishers").selectize({
				plugins: ["remove_button"], maxItems: 5, onChange: function (n) {
					t = n
				}
				...
				maxItems: 1, onChange: function (n) {
					e = n
				}
			})
		})
