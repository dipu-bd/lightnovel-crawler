...
search_url = 'https://moonstonetranslation.com/?s=%s&post_type=wp-manga&op=&author=&artist=&release=&adult='
post_chapter_url = 'https://moonstonetranslation.com/wp-admin/admin-ajax.php'


class MoonStoneTranslation(Crawler):
    ...
    def download_chapter_body(self, chapter):
        ...
        body = []
        for p in contents:
            for ad in p.select('h3, .code-block, .adsense-code, .sharedaddy, img'):
                ad.extract()
            body.append(str(p))
