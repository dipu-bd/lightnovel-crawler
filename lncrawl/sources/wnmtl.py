...
search_url = 'https://www.wnmtl.org/?s=%s&post_type=wp-manga&author=&artist=&release='
chapter_list_url = 'https://www.wnmtl.org/wp-admin/admin-ajax.php'


class WNMTLCrawler(Crawler):
    base_url = 'https://www.wnmtl.org/'

    # TODO: Disable for now as site is loading very slowly, sometimes it's find others it timesout.
