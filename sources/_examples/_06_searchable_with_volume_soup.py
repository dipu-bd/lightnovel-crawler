...
This is a sample using the SearchableSoupTemplate and ChapterWithVolumeSoupTemplate
as the template. It should be able to do searching and generating both the volumes list
