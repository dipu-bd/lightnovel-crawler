...
This is a sample using the ChapterOnlyBrowserTemplate as the template. This template
provides a wrapper around the GeneralBrowserTemplate that generates only chapter list
...
class MyCrawlerName(ChapterOnlyBrowserTemplate):
