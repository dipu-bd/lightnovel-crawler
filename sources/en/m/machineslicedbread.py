...
class MachineSlicedBreadCrawler(SoupTemplate):
    base_url = ["https://www.machineslicedbread.xyz/"]
    ...
    def select_chapter_tags(
        ...
        for anchor in tag.select(".entry-content a[href]"):
            ...
            trimmed = href.split("//", 1)[-1]
            if trimmed.startswith(prefix) and trimmed != prefix:
