...
search_url = "https://www.wuxianovelhub.com/search.html"
chapter_list_url = "https://www.wuxianovelhub.com/e/extend/fy.php"


class WuxiaNovelHubCrawler(Crawler):
    ...
    def search_novel(self, query):
        ...
        soup = self.post_soup(
            ...
            headers={
                "Referer": search_url,
                "Origin": "https://www.wuxianovelhub.com",
            ...
            result.append(
                {
                    ...
                    "info": " | ".join(
                        [x.text.strip() for x in a.select(".novel-stats")]
                    ),
                }
            )
    ...
    def read_novel_info(self):
        ...
        try:
            self.novel_author = soup.select_one(
                '.novel-info .author span[itemprop="author"]'
            ).text.strip()
        ...
        for vol_id, f in enumerate(futures, 1):
            soup = f.result()
